...
extension DeveloperToolsSupport.ColorResource {
    ...
    static let brandMuted = DeveloperToolsSupport.ColorResource(name: "BrandMuted", bundle: resourceBundle)
...
extension AppKit.NSColor {
    ...
    /// The "BrandMuted" asset catalog color.
    static var brandMuted: AppKit.NSColor {
#if !targetEnvironment(macCatalyst)
        .init(resource: .brandMuted)
#else
        .init()
#endif
    }
...
extension UIKit.UIColor {
    ...
    /// The "BrandMuted" asset catalog color.
    static var brandMuted: UIKit.UIColor {
#if !os(watchOS)
        .init(resource: .brandMuted)
#else
        .init()
...
extension SwiftUI.Color {
    ...
    /// The "BrandMuted" asset catalog color.
    static var brandMuted: SwiftUI.Color { .init(.brandMuted) }
